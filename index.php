		...
		<div class="main-header">
			<div class="zerogrid">
				...
				<div class="header-text hidden-xs">
					<div class="t-center">
						<span>Bringing People Together  with Tasty Food.</span>
						<h1>Welcome to LoveBite !</h1>
						<p>Thanks for voting us #1 Food-Finder in The World.<br>Call 9727379208</p>
		...
		<section class="content-box boxstyle-1 box-1">
			<div class="zerogrid">
				<div class="row wrap-box"><!--Start Box-->
					<div class="col-1-2">
						<div class="wrap-col">
							<h1>Welcome To<br><span>LoveBite</span></h1>
							<p class="lead">Your diet is a bank account. Good food choices are good investments.</p>
							<p>Most of us have fond memories of food from our childhood. Whether it was our mom's homemade lasagna or a memorable chocolate birthday cake, food has a way of transporting us back to the past.</p>
							<blockquote><p style="color: #111">Eating good food is my favourite thing in the whole world. Nothing is more blissf</p></blockquote>
							...
							<div class="portfolio-box-caption">
								<div class="portfolio-box-caption-content">
									...
									<div class="project-detail">
										<span> Food, in the end, in our own tradition, is something holy. It's not about nutrients and calories. It's about sharing. It's about honesty. It's about identity.</span>
									</div>
								</div>
							</div>
						</a>
						...
						<a class="portfolio-box zoom-effect" href="single.html">
							...
							<div class="portfolio-box-caption">
								<div class="portfolio-box-caption-content">
									...
									<div class="project-detail">
										<span> I was raised by a single mother who made a way for me. She used to scrub floors as a domestic worker, put a cleaning rag in her pocketbook and ride the subways in Brooklyn so I would have food on the table. But she taught me as I walked her to the subway that life is about not where you start, but where you're going. That's family values.</span>
									</div>
								</div>
							</div>
						</a>
						...
						<a class="portfolio-box zoom-effect" href="single.html">
							...
							<div class="portfolio-box-caption">
								<div class="portfolio-box-caption-content">
									...
									<div class="project-detail">
										<span> It all comes back to the basics. Serve customers the best-tasting food at a good value in a clean, comfortable restaurant, and they'll keep coming back.</span>
									</div>
								</div>
							</div>
						</a>
		...
		<section class="content-box box-3">
			<div class="zerogrid">
				<div class="wrap-box"><!--Start Box-->
					<div class="heading">
						<div class="row">
							<h2>Trending Restaurants in your city</h2>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row"><!--Start Box-->
						<div class="col-1-4">
							<div class="wrap-col item">
								<div class="portfolio-box">
									<img src="images/tinello.jpg"alt="">
								</div>
								<div class="item-content">
									<h3><a href="#">Tinello, Hyaat Regency</a></h3>
									<span>Italian</span>
								</div>
							</div>
						</div>
						<div class="col-1-4">
							<div class="wrap-col item">
								...
								<div class="item-content">
									<h3><a href="#">Mirch Masala, Thatej</a></h3>
									<span>Indian</span>
								</div>
							</div>
						</div>
						<div class="col-1-4">
							<div class="wrap-col item">
								...
								<div class="item-content">
									<h3><a href="#">Burrito Boyz, Pakwan</a></h3>
									<span>Mexican</span>
								</div>
							</div>
						</div>
						<div class="col-1-4">
							<div class="wrap-col item">
								...
								<div class="item-content">
									<h3><a href="#">Mainland China, Satellite</a></h3>
									<span>Chinese</span>
								</div>
							</div>
						</div>
					...
					<div class="row"><!--Testimonials Box-->
						<div id="owl-testimonials" class="owl-carousel t-center">
							<div class="item testimonials-item">
								...
								<h5>Tinello - Ahmedabad</h5>
							</div>
							<div class="item testimonials-item">
								<img src="images/back2.jpg" />
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley.</p>
								<h5>The Grand Bhagwati - Surat</h5>
							</div>
							<div class="item testimonials-item">
								<img src="images/back3.jpg"/>
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley.</p>
								<h5>Mirch Masala - Ahmedabad</h5>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-1-3">
							<div class="wrap-col">
								...
								<div class="col-2-3 t-left">
									<h3>Address</h3>
									<p>"Kushan", Surdhara, Ahmedabdad 382478</p>
								</div>
							</div>
						</div>
						<div class="col-1-3">
							<div class="wrap-col">
								...
								<div class="col-2-3 t-left">
									<h3>Phone</h3>
									<p>Main Office 9727379208, 9925881060</p>
								</div>
							</div>
						</div>
						<div class="col-1-3">
							<div class="wrap-col">
								...
								<div class="col-2-3 t-left">
									<h3>Email</h3>
									<p><span>Email One :</span> 14bce123@nirmauni.ac.in </p>
								</div>
							</div>
						</div>
					</div>
