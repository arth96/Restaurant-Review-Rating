			...
			<div class="wrap-container zerogrid">
				<div class="crumbs">
					<ul>
						...
						<li><a href="archive.html">Explore</a></li>
					</ul>
				</div>
				<div id="main-content">
					<div class="wrap-content">
						...
						<a href="rest.php" style="color:black" name="Area"><ki><kiv class="grow"><b>Area</b></kiv></ki></a>				
						<a href="rest1.php" style="color:black" name="Food"><ki><kiv class="grow"><b>Food</b></kiv></ki></a>			
						</form>
						</ul>
					</div>
				</div>
